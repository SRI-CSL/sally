...
public:
  ...
  /** Add to map and make sure check that the names are not clashing with each other */
  void add_to_renaming_map(sal::module::id_to_lvalue& map, std::string id, expr::term_ref lvalue);
   ...
   */
  void load_module_to_module(sal::module::ref m_from, sal::module::ref m_to, const sal::module::id_to_lvalue& subst, symbol_override allow_override);
  ...
  void module_modify_rename(sal::module::ref m, sal::module::ref m_rename, const sal::module::id_to_lvalue& subst_map);

  /** Modify m by adding m_with */
  void module_modify_with(sal::module::ref m, sal::module::ref m_with);

  /** Get the sal variable class of the given lvalue */
  sal::variable_class get_lvalue_class(expr::term_ref lvalue);
