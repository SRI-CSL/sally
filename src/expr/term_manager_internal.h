...
#define SWITCH_TO_TERM(OP) case OP: result = mk_term<OP>(begin, end); break;
  ...
  switch (op) {
    ...
    SWITCH_TO_TERM(TERM_BV_REDAND)
    SWITCH_TO_TERM(TERM_BV_REDOR)
    SWITCH_TO_TERM(TERM_BV_REDXOR)
    SWITCH_TO_TERM(TERM_BV_ROR)
    SWITCH_TO_TERM(TERM_BV_ROL)
    SWITCH_TO_TERM(TERM_BV_UADDO)
    SWITCH_TO_TERM(TERM_BV_SADDO)
    SWITCH_TO_TERM(TERM_BV_USUBO)
    SWITCH_TO_TERM(TERM_BV_SSUBO)
    SWITCH_TO_TERM(TERM_BV_UMULO)
    SWITCH_TO_TERM(TERM_BV_SMULO)
    SWITCH_TO_TERM(TERM_BV_UDIVO)
    SWITCH_TO_TERM(TERM_BV_SDIVO)
